...
local web = true
local user = "901wia"
local repo = "hydroxideupvaluesfixed"
local branch = "main"
local importCache = {}
...
local releaseInfo = HttpService:JSONDecode(game:HttpGetAsync("https://api.github.com/repos/" .. user .. "/" .. repo .. "/releases"))[1]
            ...
            elseif web then
                if readFile and writeFile then
                    ...
                    if (isFile and not isFile(file)) or not importCache[asset] then
                        content = game:HttpGetAsync("https://raw.githubusercontent.com/" .. user .. "/" .. repo .. "/" .. branch .. '/' .. asset .. ".lua")
                    ...
                    assets = { loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/" .. user .. "/" .. repo .. "/" .. branch .. '/' .. asset .. ".lua"), asset .. '.lua')() }
                end
            else
